...
using ElmahCore.Mvc;
using ElmahCore;
using Tracing.Api.Filters;
using Tracing.Business.Installer;

namespace Tracing.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Tracing API", Version = version + "-" + branch});
            });
